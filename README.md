...
<head>
    ...
    <style>
        ...
        .modal-content h2 { font-size: 28px; margin-top: 0; color: #16a085; }
        ...
        .modal-content button:hover { background-color: #138d75; }
    </style>
</head>
<body>
        ...
        setInterval(function() {
            ...
            if (gameLoopCounter >= 5) { 
                ...
                if (eventChance < eventThreshold1) {
                    ...
                    logMessage(`🦠 เกิดโรคระบาดแพร่กระจายในเมือง! มลพิษพุ่ง +${diseasePollution}%`, "danger");
